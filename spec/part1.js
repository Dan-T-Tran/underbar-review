  ...
  describe('Part I', function() {
    ...
    describe('each', function() {
      ...
      it('should only iterate over numeric keys of an array, not all properties', function() {
        ...
        //Just in case, replace with letters.someProperty vvv
    ...
    describe('reduce', function() {
      ...
      it('should pass every item of the array if accumulator is falsy but not undefined', function() {
        var result = _.reduce([1, 2, 3], function(memo, item) {
          return memo * item;
        }, 0);
